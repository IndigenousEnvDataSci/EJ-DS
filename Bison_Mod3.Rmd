...
2) Looking at all of the data: Biomass data and then maybe also a data frame that just has the size information of the different sites (in hectares)
...
```{r}
#Write your code here to visualize your nitrogen data!
```
