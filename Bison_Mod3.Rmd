...
We should take the average biomass per quadrant again, but this time with the converted units. *No code will be given*
...
*We are strongly considering not having them do anything with Nitrogen, both for the sake of time and also since we can't find a number online for nitrogen requirements of bison. Ignore N section for now!*
import N dataset 
```{r import N dataset}
