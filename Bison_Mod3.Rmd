...
```{r maximum bison}
total_available<-mutate(total_available, max_bison=total_biomass/21900) #maybe come up with a different name
print(total_available)
```
...
2) each site has x, y, z of elk
  - multiply number of elk by kg of biomass per elk (2,158 kg/year)
