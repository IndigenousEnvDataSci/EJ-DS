...
ANSWER (click the arrow next to 180 to see the answer)
```{r}
...
*NOTE* This is filled in for the instructor's version, but will be left blank for students to work together to construct on their own. 
```{r}
stream_DO <- stream_DO %>%  
  pivot_longer( 
    cols = c(StreamA, StreamB), 
...
is in the water across Stream A and Stream B? 
