...
Now that you've loaded in and explored that data from each of the sites, it will be useful to combine it in one large data set. Use what you have learned in the previous parts to combine the data sets. 
...
site_4_new <- site_4 %>%
  mutate(site_ID = 4)
#The function rbind combines the data vertically. This places all of the site 2,
#3, and 4 below the data from site 1.
