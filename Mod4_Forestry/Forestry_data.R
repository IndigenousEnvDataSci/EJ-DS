...
# Site 1
  ...
  site_1 <- data.frame(age = seq(20, 160, by = 10), 
    ...
    tree_density = c(0, 165, 278, 322, 308, 279, 250, 224, 204, 186, 171, 159, 149, 141, 133))
...
# Site 2
  ...
  site_2 <- data.frame(age = seq(20, 160, by = 10), 
    ...
    tree_density = c(148, 247, 218, 173, 137, 113, 97, 84, 75, 69, 63, 59, 55, 51, 48))
  ## Jittering data so it isn't a perfect line
...
# Site 3
  ...
  site_3 <- data.frame(age = seq(20, 160, by = 10), 
    ...
    tree_density = c(0, 0, 124, 220, 276, 305, 318, 307, 293, 278, 263, 250, 237, 227, 217))
  ## Jittering data so it isn't a perfect line
...
# Site 4
  ...
  site_4 <- data.frame(age = seq(20, 160, by = 10), 
    ...
    tree_density = c(119, 254, 269, 231, 190, 158, 136, 118, 106, 95, 87, 80, 75, 71, 67))
  ## Jittering data so it isn't a perfect line
