...
Before loading data, let's return to the reference dose (RfD). We can use R to calculate how much methylmercury can safely be consumed per day based on a person's weight. Run the code below, and then change the `weight` variable to see how the safe amount of consumption changes. 
