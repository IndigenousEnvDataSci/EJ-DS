...
optional opportunity here to add in data frame example by creating your own i.e. https://swcarpentry.github.io/r-novice-gapminder/05-data-structures-part2.html

- vectors of weight, consumption
- list to add a row 
- do math to add another vector that shows the safe limit 
