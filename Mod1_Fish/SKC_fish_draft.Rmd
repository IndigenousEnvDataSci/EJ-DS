...
<<<<<<< HEAD
fish_1998- name of data
%>%- sets the data frame
ggplot- calls up the package
aes- what you can see (so the axes)
+- to add components to the plot
geom_jitter- makes the ribbon plot
...
#fish_1998 data
fish_1998 %>%
#ggplot is just a function that we are using to create a plot. It needs some
#information which is stored in the aes() function, such as what variable 
#is on the x-axis (which is the x = length part)
#and what variable is on the y (the y= mercury part)
